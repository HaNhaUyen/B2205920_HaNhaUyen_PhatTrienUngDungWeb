<template>
  <div class="pa-0 ma-0 w-100" style="width: 100vw; overflow-x: hidden">
    <v-carousel :show-arrows="false" hide-delimiters cycle :interval="2000">
      <v-carousel-item
        ...
        <v-row no-gutters class="w-100">
          ...
          >
            <div class="d-flex flex-column justify-center align-start h-100">
              ...
              <p class="text-body-1">
                Một cuốn sách đặc sắc với nội dung hấp dẫn, mời bạn khám phá
                thêm!
              </p>
            </div>
          </v-col>
      ...
      featuredBooks: [
        {
          ...
          author: "Mashima Hiro",
          image:
            "https://image.api.playstation.com/vulcan/img/rnd/202007/1305/oNkLAxLkFuLVcaJ6XpaNkkNb.png",
        },
        {
          id: 2,
          title: "Harry Potter",
