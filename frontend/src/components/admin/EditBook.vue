  ...
  <div class="flex justify-center items-center bg-white mt-10">
    ...
    >
      <div class="text-center mb-6 mt-4">
        <v-icon size="48" class="text-black mb-2"
...
export default {
  ...
  methods: {
    async fetchInitialData() {
      ...
      try {
        const [bookRes, authorsRes, categoriesRes, publishersRes] =
          await Promise.all([
    ...
    async submitForm(values) {
      ...
      try {
        ...
        // Delay 1s rồi mới chuyển về trang BookManager
