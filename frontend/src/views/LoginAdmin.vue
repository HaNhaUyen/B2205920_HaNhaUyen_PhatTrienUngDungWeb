  ...
  <div class="h-[80vh] flex justify-center items-center bg-white mt-10">
    ...
    >
      <div class="text-center mb-6 mt-4">
        <v-icon size="48" class="text-black mb-2">mdi-shield-account</v-icon>
        <h2 class="text-2xl font-bold text-black">Đăng nhập Admin</h2>
  ...
  methods: {
    async submitLogin(values) {
      try {
        ...
        if (user.role !== "admin") {
          this.serverError = "Bạn không có quyền truy cập (chỉ admin)";
          return;
        }
